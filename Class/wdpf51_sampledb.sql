...
--
-- Host: 127.0.0.1
-- Generation Time: Jan 04, 2023 at 01:53 PM
...
-- Functions
--
CREATE DEFINER=`root`@`localhost` FUNCTION `calculate_discount` (`cust_id` CHAR(8)) RETURNS DECIMAL(10,2) COMMENT 'Calculate Customers discount' BEGIN
...
--
-- Dumping data for table `employees3`
--

INSERT INTO `employees3` (`firstname`, `lastname`) VALUES
('Diane', 'Murphy'),
('Mary', 'Patterson'),
('Jeff', 'Firrelli'),
('William', 'Patterson'),
